...
$(function() {
    ...
    $signup.mouseover(function(event) {
     ...
     $('aside').find('textarea').focus(function(event) {
        $(this).animate({height:'100px'}, "normal");
     }).blur(function(event) {
        $(this).animate({height:'30px'}, "normal");
     });
     $('.span4'>'.gravatar').mouseover(function(event) {
        $(this).animate({borderRadius:'50%'}, "slow");
     }).mouseout(function(event) {
        $(this).animate({borderRadius:'5%'}, "slow");
     });;
     $('.feed-item-right').find('a').mouseover(function(event) {
